	...
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" :bottom="100">
		<view class="container">
					...
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.yonghuzhanghao}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"","margin":"","borderColor":"#fff","backgroundColor":"rgba(255, 255, 255, 0.56)","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"180rpx","fontSize":"28rpx","color":"#333","textAlign":"left"}'>用户姓名：</view>
					...
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.lianxidianhua}}</view>
                				                				...
                				                				<view class="detail-list-item" :style='{"boxShadow":"","margin":"","borderColor":"#fff","backgroundColor":"rgba(255, 255, 255, 0.56)","borderRadius":"0","borderWidth":"0","borderStyle":"solid","height":"68rpx"}'>
					<view class="lable" :style='{"width":"180rpx","fontSize":"28rpx","color":"#333","textAlign":"left"}'>电子邮箱：</view>
					<view class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>{{detail.dianziyouxiang}}</view>
				</view>
